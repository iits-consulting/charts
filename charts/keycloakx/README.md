...
| common.externalSecret.pull.secrets.keycloakx-eso-database.path | string | `"playground/data/infra/keycloak/keycloak_database_credentials"` |  |
...
| common.externalSecret.pull.secrets.keycloakx-eso-env.path | string | `"playground/data/infra/keycloak/keycloak_admin_credentials"` |  |
