...
| keycloakx.database.database | string | `""` |  |
| keycloakx.database.hostname | string | `""` |  |
| keycloakx.database.password | string | `""` |  |
| keycloakx.database.port | string | `""` |  |
| keycloakx.database.username | string | `""` |  |
| keycloakx.database.vendor | string | `""` |  |
...
| postgresOperator.databases.keycloak.dropOnDelete | bool | `false` |  |
| postgresOperator.databases.keycloak.users.keycloak.privileges | string | `"OWNER"` |  |
| postgresOperator.databases.keycloak.users.keycloak.secretName | string | `"keycloak"` |  |
