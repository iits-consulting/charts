...
- Update gogatekeeper helm chart version to 0.1.66
- Updates gogatekeeper app version from 3.3 to 5.0, check [UPGRADE.md](./UPGRADE.md) for details
...
- Add optional ESO integration via common chart
