...
![Version: 8.17.0](https://img.shields.io/badge/Version-8.17.0-informational?style=flat-square)
...
| elasticsearch.version | string | `"8.17.0"` |  |
...
| filebeat.version | string | `"8.17.0"` |  |
...
| generatePasswords.image.tag | float | `1.32` |  |
...
| kibana.podTemplateSpec.initContainers[0].name | string | `"elastic-internal-init-config"` |  |
