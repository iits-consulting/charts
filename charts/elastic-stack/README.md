...
![Version: 8.5.1](https://img.shields.io/badge/Version-8.5.1-informational?style=flat-square)
...
| filebeat.daemonset.extraEnvs[0].name | string | `"STAGE"` |  |
| filebeat.daemonset.extraEnvs[0].value | string | `"REPLACE_ME"` |  |
